...
export const SECTIONS = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'pregunta-auri', label: 'Pregúntale a Auri', icon: `${import.meta.env.BASE_URL}auri-cara.png`, desc: 'No un chat largo — una conversación corta, siempre con opciones para elegir.', active: false },
